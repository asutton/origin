...
// Input iterator
template<typename I>
  concept bool Input_iterator() { return Readable<I>() && Advanceable<I>(); }

// Output iterator
template<typename I, typename T>
  concept bool Output_iterator() { return Writable<I, T>() && Advanceable<I>(); }
...
template<typename T, typename I>
  concept bool Sentinel() {
    return Copyable<T>() and Equality_comparable<T, I>();
  }
